...
from asap_client import rest
from asap_client.configuration import Configuration
from asap_client.exceptions import ApiTypeError, ApiValueError, ApiException
from asap_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DefensesApi()
        api_instance.get_defense  # this is an instance of the class Endpoint
        api_instance.get_defense()  # this invokes api_instance.get_defense.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_defense.callable or self.callable in this class
