    ...
    def __init__(self, api_client=None):
        ...
        def __create_key(
            ...
            **kwargs
            ...
            >>> thread = api.create_key(async_req=True)
            >>> result = thread.get()
        ...
        self.delete_key = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'JWT'
                ],
                'endpoint_path': '/api/v1/keys/{id}',
