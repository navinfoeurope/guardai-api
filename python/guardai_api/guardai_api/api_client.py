...
from guardai_api import rest
from guardai_api.configuration import Configuration
from guardai_api.exceptions import ApiTypeError, ApiValueError, ApiException
from guardai_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BenchmarkApi()
        api_instance.add_benchmark  # this is an instance of the class Endpoint
        api_instance.add_benchmark()  # this invokes api_instance.add_benchmark.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_benchmark.callable or self.callable in this class
