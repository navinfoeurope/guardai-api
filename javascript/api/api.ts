...
export const OrganizationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {'Coco' | 'Ksv' | 'VOCDetection' | 'VOCSegmentation'} [format] 
         * @param {string} [name] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateCustomDataset: async (datasetId: number, id: number, description?: string, format?: 'Coco' | 'Ksv' | 'VOCDetection' | 'VOCSegmentation', name?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'datasetId' is not null or undefined
         ...
         * @param {'Coco' | 'Ksv' | 'VOCDetection' | 'VOCSegmentation'} format format
         * @param {number} id The organization ID.
         ...
         * @throws {RequiredError}
         */
        uploadDataset: async (description: string, format: 'Coco' | 'Ksv' | 'VOCDetection' | 'VOCSegmentation', id: number, name: string, file?: any, options: any = {}): Promise<RequestArgs> => {
...
export const OrganizationApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async updateCustomDataset(datasetId: number, id: number, description?: string, format?: 'Coco' | 'Ksv' | 'VOCDetection' | 'VOCSegmentation', name?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<DataSet>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateCustomDataset(datasetId, id, description, format, name, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async uploadDataset(description: string, format: 'Coco' | 'Ksv' | 'VOCDetection' | 'VOCSegmentation', id: number, name: string, file?: any, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<DataSet>>> {
...
export const OrganizationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        updateCustomDataset(datasetId: number, id: number, description?: string, format?: 'Coco' | 'Ksv' | 'VOCDetection' | 'VOCSegmentation', name?: string, options?: any): AxiosPromise<Array<DataSet>> {
            return localVarFp.updateCustomDataset(datasetId, id, description, format, name, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Update organization.
         ...
         * @throws {RequiredError}
         */
        uploadDataset(description: string, format: 'Coco' | 'Ksv' | 'VOCDetection' | 'VOCSegmentation', id: number, name: string, file?: any, options?: any): AxiosPromise<Array<DataSet>> {
...
export class OrganizationApi extends BaseAPI {
     ...
     * @memberof OrganizationApi
     */
    public updateCustomDataset(datasetId: number, id: number, description?: string, format?: 'Coco' | 'Ksv' | 'VOCDetection' | 'VOCSegmentation', name?: string, options?: any) {
        return OrganizationApiFp(this.configuration).updateCustomDataset(datasetId, id, description, format, name, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrganizationApi
     */
    public uploadDataset(description: string, format: 'Coco' | 'Ksv' | 'VOCDetection' | 'VOCSegmentation', id: number, name: string, file?: any, options?: any) {
...
export const ProjectApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @summary Add a project to a organization.
